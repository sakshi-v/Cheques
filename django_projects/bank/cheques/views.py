...
##User-Employee/Customer. This method displays login page.
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function
def login(request):
	return render_to_response('cheques/login.html')

##User-Employee. This method aunthenticates employee username and password. Authentication is successful if username and password are correct,else: display the error message
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function if authentication is successful,else: display error message
...
## User-Employee. This method searches the Account table in the database for the account number.
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function if search is successful, else: display error message
...
##User-Employee. This method displays Cheque Menu which will be accessed by employee.
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function
...
##User-Employee. This method issues a cheque book of selected size
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function	
...
## User-Employee.This method deducts the amount from drawee's account, if cheque number,cheque date and amount entered in the cheque payment form are valid, else: displays the corresponding error message
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function if cheque payment is successful,else: display error message
...
##User-Employee. This method cancels the cheque if cheque number is valid,else: display the corresponding error message
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function if cheque cancellation is successful, else: display error message
...
##User-Employee. This method displays the status of the cheque if cheque number is valid, else: display the corresponding the error message
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function if cheque number is valid, else:display error message
...
##User-Employee. This method sets all global variables to zero and displays the login page 
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function
...
##User-Customer.This method aunthenticates customer username and password. Authentication is successful if username and password are correct,else: display the error message
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function if authentication is successful,else: display error message
...
##User-Customer.This method displays Cheque Menu which will be accessed by customer.
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function
...
##User-Customer. This method cancels the cheque if cheque number is valid, else: display the corresponding error message
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function if cheque cancellation is successful,else: display error message
...
## User-Customer. This method displays the status of the cheque if cheque number is valid ,else: display the corresponding the error message
##@param request HttpRequest, the request created by user 
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function if cheque number is valid, else: display error message
...
##User-Customer. This method sets all global variables to zero and displays the login page
##@param request HttpRequest, the request created by user
##@return HTTPResponse Object,containing the name of the template which is to be rendered,and its context,which contains all the local variables of this function
